...
if(isset($_GET['toDate'])) {
	...
	$req=$bdd->prepare('INSERT INTO edt
     ...
     SELECT :T, debutedt, groupeedt, typeenseignementedt, finedt, filiereedt, matiereedt, enseignantedt, salleedt, ligneedt, positionedt, couleuredt, :ToJour, :ToNumSemaine, dept, annee, numero, enseignantedt2, "comment5", enseignantedt4, salleedt2, salleedt3, salleedt4, memoedt, idmat
      FROM edt WHERE jouredt=:ToJour AND semaineedt=:ToNumSemaine AND groupeedt=:Fill AND annee="2013"') ;
	$req->execute(array(
		'F' => $fromDate,
		'T' => $toDate,
		'Fill' => $filiere,
